...
storiesOf("Button", module)
  .add("Отмена", () => <Button onClick={action("clicked")} value="Отмена" />)
  .add("Hovered", () => (
    <Button onClick={action("clicked")} value="Отмена" state="hover" />
  ))
  .add("Активная", () => (
    <Button onClick={action("clicked")} state="active" value="Отмена" />
  ))
  .add("Заблокирована", () => (
    <Button onClick={action("clicked")} state="disabled" value="Отмена" />
  ));

storiesOf("Submit", module)
  .add("Создать", () => <Submit onClick={action("clicked")} value="Создать" />)
  .add("Hovered", () => (
    <Submit onClick={action("clicked")} value="Создать" state="hover" />
  ))
  .add("Активная", () => (
    <Submit onClick={action("clicked")} state="active" value="Создать" />
  ))
  .add("Заблокирована", () => (
...
storiesOf("Title", module).add("Value", () => (
